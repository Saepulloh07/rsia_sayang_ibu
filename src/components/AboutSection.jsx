    ...
    <Box sx={{ py: { xs: 6, md: 8 }, backgroundColor: "#F8F9FA" }}>
      ...
      <Container maxWidth="md">
        ...
        >
          ...
          terkemuka di Tanah Datar, Sumatera Barat. Kami berkomitmen menyediakan
          layanan kesehatan berkualitas tinggi dengan fasilitas modern, tim
          medis profesional, serta pelayanan yang penuh kasih sayang untuk
        ...
        >
          ...
          <li>Membentuk SDM yang bertakwa, solid, kompeten, dan produktif.</li>
          <li>
          ...
          <li>Menerapkan budaya Islami dalam penampilan dan pelayanan.</li>
        </Box>
